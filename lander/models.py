...
var
lander_material_pink = {ambient: [0.5, 0.0, 0.5], diffuse: [0.5, 0.0, 0.5], specular: [1.0, 1.0, 1.0], phong: 4.0};
var
lander_material_purple = {ambient: [0.3, 0.0, 0.5], diffuse: [0.3, 0.0, 0.5], specular: [1.0, 1.0, 1.0], phong: 4.0};
var
lander_material_darkpurple = {ambient: [0.1, 0.0, 0.3], diffuse: [0.2, 0.0, 0.4], specular: [1.0, 1.0, 1.0],
                              phong: 4.0};

var
lander_material_green = {ambient: [0.0, 0.3, 0.0], diffuse: [0.3, 0.8, 0.3], specular: [0.0, 0.0, 0.0], phong: 1.0};
var
lander_material_brown = {ambient: [0.2, 0.1, 0.0], diffuse: [0.4, 0.2, 0.0], specular: [0.0, 0.0, 0.0], phong: 1.0};

var
lander_model_ship = {vertices: [[[-0.6, 0.0, -0.5, 1.0],
                                 [0.6, 0.0, -0.5, 1.0],
                                 [0.3, 0.0, 0.5, 1.0],
                                 [-0.3, 0.0, 0.5, 1.0],
                                 [-0.2, -0.4, -0.5, 1.0],
...
alien1_a = 0.8;
const
alien1_b = alien1_a * Math.sin(Math.PI / 4);
const
alien1_c = 0.4;

var
lander_model_alien1 = {vertices: [[[0.0, 0.0, -alien1_a, 1.0],
...
tree_a = 0.2;
const
tree_b = tree_a * Math.sin(Math.PI / 6);
const
tree_c = tree_a * Math.cos(Math.PI / 6);

const
tree_d = 0.5;
const
tree_e = tree_d * Math.sin(Math.PI / 6);
const
tree_f = tree_d * Math.cos(Math.PI / 6);
...
var
lander_model_tree = {vertices: [[[0.0, 0.0, tree_a, 1.0],
...
debris_a = 0.4;
const
debris_b = debris_a * Math.sin(Math.PI / 6);
const
debris_c = debris_a * Math.cos(Math.PI / 6);

var
lander_model_debris = {vertices: [[[0.0, 0.0, debris_a, 1.0],
