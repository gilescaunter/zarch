...
const
lander_hud_dotsize = 3;
const
lander_hud_dotedge = 64 - lander_hud_dotsize;

function
lander_hud_dot(ctx, x, y)
{
    var
...
var
lander_hud_health = 1.0;

function
lander_hud_draw(ctx)
{
    var
fuel = lander_ship.get_fuel();
var
health = lander_ship.get_health();
